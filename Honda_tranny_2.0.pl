...
#
#-----------------------------------------------------------------------#
# Author: Kyle Steinkamp                                                #
# Date:   2013/01/01 11:12:13                                           #
# Email:  kyle@hobopanda.com                                            #
#-----------------------------------------------------------------------#
#

my $pi = "3.141592654";
my $speedconst = "336.1352";
my $ktom = "0.621371192237";
my $mtok = "1.609344";
my $mmtoin = "25.4";

my $inches_in_a_mile = "63360";
my $wheel1 = "73.733";
#my $wheel1 = "73.733"; 205/40/r17
my $fd_1 = "4.900";
my $fd_2 = "4.250";
my $fd_3 = "4.058";
my $rpm_1 = $ARGV[0];
...
foreach $gearx (@gears) {
     ...
     $gearx, $speed, $speed2, $speed3, $rpm_1, $wheel1, ;
     }
print "+-------+----------+----------+----------+----------+------------+-----------+\n";
